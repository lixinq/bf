				...
				<tr class="hover-toggle">
					...
					<td>
						...
						<div class="hover-item small">
							<a href="<?=base_url()?>admin/developer/database/get_backup/<?php echo $file ?>" title="Download this file"><?php echo lang('bf_action_download'); ?></a> |
							<a href="<?=base_url()?>admin/developer/database/restore/<?php echo $file ?>" title="Restore this file"><?php echo lang('db_restore'); ?></a>
						</div>
					</td>
