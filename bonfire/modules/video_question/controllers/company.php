...
class company extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Video_Question.Company.View');
	...
	*/
	...
	{
		$this->auth->restrict('Video_Question.Company.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_video_question())
			{
				...
				Template::redirect(SITE_AREA .'/company/video_question');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/company/video_question');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Video_Question.Company.Edit');
		...
		{
			$this->auth->restrict('Video_Question.Company.Delete');
