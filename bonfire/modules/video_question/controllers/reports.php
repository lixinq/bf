...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Video_Question.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Video_Question.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_video_question())
			{
				...
				Template::redirect(SITE_AREA .'/reports/video_question');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/video_question');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Video_Question.Reports.Edit');
		...
		{
			$this->auth->restrict('Video_Question.Reports.Delete');
