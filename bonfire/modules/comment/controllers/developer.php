...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Comment.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Comment.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_comment())
			{
				...
				Template::redirect(SITE_AREA .'/developer/comment');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/comment');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Comment.Developer.Edit');
		...
		{
			$this->auth->restrict('Comment.Developer.Delete');
