...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Comment.Content.View');
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/comment');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Comment.Content.Edit');
		...
		{
			$this->auth->restrict('Comment.Content.Delete');
