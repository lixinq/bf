...
class commonauth extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Comment.Commonauth.View');
	...
	*/
	...
	{
		$this->auth->restrict('Comment.Commonauth.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_comment())
			{
				...
				Template::redirect(SITE_AREA .'/commonauth/comment');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/commonauth/comment');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Comment.Commonauth.Edit');
		...
		{
			$this->auth->restrict('Comment.Commonauth.Delete');
