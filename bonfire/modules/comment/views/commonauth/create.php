...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create Comment" />
            or <?php echo anchor(SITE_AREA .'/commonauth/comment', lang('comment_cancel'), 'class="btn btn-warning"'); ?>
