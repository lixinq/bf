...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('User_information.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('User_information.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_user_information())
			{
				...
				Template::redirect(SITE_AREA .'/reports/user_information');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/user_information');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('User_information.Reports.Edit');
		...
		{
			$this->auth->restrict('User_information.Reports.Delete');
