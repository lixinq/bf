...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create text form" />
            or <?php echo anchor(SITE_AREA .'/commonauth/text_form', lang('text_form_cancel'), 'class="btn btn-warning"'); ?>
