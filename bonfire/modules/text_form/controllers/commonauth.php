...
class commonauth extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Text_form.Commonauth.View');
	...
	*/
	...
	{
		$this->auth->restrict('Text_form.Commonauth.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_text_form())
			{
				...
				Template::redirect(SITE_AREA .'/commonauth/text_form');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/commonauth/text_form');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Text_form.Commonauth.Edit');
		...
		{
			$this->auth->restrict('Text_form.Commonauth.Delete');
