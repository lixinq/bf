...
class company extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Text_form.Company.View');
	...
	*/
	...
	{
		$this->auth->restrict('Text_form.Company.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_text_form())
			{
				...
				Template::redirect(SITE_AREA .'/company/text_form');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/company/text_form');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Text_form.Company.Edit');
		...
		{
			$this->auth->restrict('Text_form.Company.Delete');
