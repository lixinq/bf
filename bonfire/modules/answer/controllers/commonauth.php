...
class commonauth extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Answer.Commonauth.View');
	...
	*/
	...
	{
		$this->auth->restrict('Answer.Commonauth.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_answer())
			{
				...
				Template::redirect(SITE_AREA .'/commonauth/answer');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/commonauth/answer');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Answer.Commonauth.Edit');
		...
		{
			$this->auth->restrict('Answer.Commonauth.Delete');
