...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Answer.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Answer.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_answer())
			{
				...
				Template::redirect(SITE_AREA .'/content/answer');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/answer');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Answer.Content.Edit');
		...
		{
			$this->auth->restrict('Answer.Content.Delete');
