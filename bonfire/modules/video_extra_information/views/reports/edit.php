...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/reports/video_extra_information', lang('video_extra_information_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Video_extra_information.Reports.Delete')) : ?>
