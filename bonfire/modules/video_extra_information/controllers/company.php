...
class company extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Video_extra_information.Company.View');
	...
	*/
	...
	{
		$this->auth->restrict('Video_extra_information.Company.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_video_extra_information())
			{
				...
				Template::redirect(SITE_AREA .'/company/video_extra_information');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/company/video_extra_information');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Video_extra_information.Company.Edit');
		...
		{
			$this->auth->restrict('Video_extra_information.Company.Delete');
