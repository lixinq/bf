...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Video_extra_information.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Video_extra_information.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_video_extra_information())
			{
				...
				Template::redirect(SITE_AREA .'/reports/video_extra_information');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/video_extra_information');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Video_extra_information.Reports.Edit');
		...
		{
			$this->auth->restrict('Video_extra_information.Reports.Delete');
