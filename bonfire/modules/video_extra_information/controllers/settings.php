...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Video_extra_information.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Video_extra_information.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_video_extra_information())
			{
				...
				Template::redirect(SITE_AREA .'/settings/video_extra_information');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/video_extra_information');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Video_extra_information.Settings.Edit');
		...
		{
			$this->auth->restrict('Video_extra_information.Settings.Delete');
