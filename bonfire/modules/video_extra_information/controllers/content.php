...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Video_extra_information.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Video_extra_information.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_video_extra_information())
			{
				...
				Template::redirect(SITE_AREA .'/content/video_extra_information');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/video_extra_information');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Video_extra_information.Content.Edit');
		...
		{
			$this->auth->restrict('Video_extra_information.Content.Delete');
