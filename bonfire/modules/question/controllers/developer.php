...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Question.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Question.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_question())
			{
				...
				Template::redirect(SITE_AREA .'/developer/question');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/question');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Question.Developer.Edit');
		...
		{
			$this->auth->restrict('Question.Developer.Delete');
