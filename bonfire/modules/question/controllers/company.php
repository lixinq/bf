...
class company extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Question.Company.View');
	...
	*/
	...
	{
		$this->auth->restrict('Question.Company.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_question())
			{
				...
				Template::redirect(SITE_AREA .'/company/question');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/company/question');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Question.Company.Edit');
		...
		{
			$this->auth->restrict('Question.Company.Delete');
