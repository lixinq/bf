...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Incentive.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Incentive.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_incentive())
			{
				...
				Template::redirect(SITE_AREA .'/reports/incentive');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/incentive');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Incentive.Reports.Edit');
		...
		{
			$this->auth->restrict('Incentive.Reports.Delete');
