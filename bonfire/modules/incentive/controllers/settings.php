...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Incentive.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Incentive.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_incentive())
			{
				...
				Template::redirect(SITE_AREA .'/settings/incentive');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/incentive');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Incentive.Settings.Edit');
		...
		{
			$this->auth->restrict('Incentive.Settings.Delete');
