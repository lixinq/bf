...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Incentive.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Incentive.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_incentive())
			{
				...
				Template::redirect(SITE_AREA .'/content/incentive');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/incentive');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Incentive.Content.Edit');
		...
		{
			$this->auth->restrict('Incentive.Content.Delete');
