...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Prescreen.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Prescreen.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_prescreen())
			{
				...
				Template::redirect(SITE_AREA .'/content/prescreen');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/prescreen');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Prescreen.Content.Edit');
		...
		{
			$this->auth->restrict('Prescreen.Content.Delete');
