...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Prescreen.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Prescreen.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_prescreen())
			{
				...
				Template::redirect(SITE_AREA .'/reports/prescreen');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/prescreen');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Prescreen.Reports.Edit');
		...
		{
			$this->auth->restrict('Prescreen.Reports.Delete');
