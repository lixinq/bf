...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Prescreen.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Prescreen.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_prescreen())
			{
				...
				Template::redirect(SITE_AREA .'/settings/prescreen');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/prescreen');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Prescreen.Settings.Edit');
		...
		{
			$this->auth->restrict('Prescreen.Settings.Delete');
