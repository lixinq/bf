...
class commonauth extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Prescreen.Commonauth.View');
	...
	*/
	...
	{
		$this->auth->restrict('Prescreen.Commonauth.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_prescreen())
			{
				...
				Template::redirect(SITE_AREA .'/commonauth/prescreen');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/commonauth/prescreen');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Prescreen.Commonauth.Edit');
		...
		{
			$this->auth->restrict('Prescreen.Commonauth.Delete');
