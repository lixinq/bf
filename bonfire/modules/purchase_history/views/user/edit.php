...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/user/purchase_history', lang('purchase_history_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Purchase_history.User.Delete')) : ?>
