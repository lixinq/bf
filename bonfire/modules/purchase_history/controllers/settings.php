...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Purchase_history.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Purchase_history.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_purchase_history())
			{
				...
				Template::redirect(SITE_AREA .'/settings/purchase_history');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/purchase_history');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Purchase_history.Settings.Edit');
		...
		{
			$this->auth->restrict('Purchase_history.Settings.Delete');
