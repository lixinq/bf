...
<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="control-group <?php echo form_error('video_path') ? 'error' : ''; ?>">
            <?php echo form_label('Upload video'. lang('bf_form_label_required'), 'video_path', array('class' => "control-label") ); ?>
            <div class='controls'>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Edit Video" />
            or <?php echo anchor(SITE_AREA .'/content/video', lang('video_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Video.Content.Delete')) : ?>

            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('video_delete_confirm'); ?>')">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('video_delete_record'); ?>
            </button>
