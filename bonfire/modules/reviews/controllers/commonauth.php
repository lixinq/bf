...
class commonauth extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Reviews.Commonauth.View');
	...
	*/
	...
	{
		$this->auth->restrict('Reviews.Commonauth.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_reviews())
			{
				...
				Template::redirect(SITE_AREA .'/commonauth/reviews');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/commonauth/reviews');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Reviews.Commonauth.Edit');
		...
		{
			$this->auth->restrict('Reviews.Commonauth.Delete');
