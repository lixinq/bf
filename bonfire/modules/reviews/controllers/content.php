...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Reviews.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Reviews.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_reviews())
			{
				...
				Template::redirect(SITE_AREA .'/content/reviews');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Reviews.Content.Edit');
		...
		{
			$this->auth->restrict('Reviews.Content.Delete');
