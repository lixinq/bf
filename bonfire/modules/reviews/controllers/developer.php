...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Reviews.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Reviews.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_reviews())
			{
				...
				Template::redirect(SITE_AREA .'/developer/reviews');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/reviews');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Reviews.Developer.Edit');
		...
		{
			$this->auth->restrict('Reviews.Developer.Delete');
