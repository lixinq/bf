...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Edit Reviews" />
            or <?php echo anchor(SITE_AREA .'/commonauth/reviews', lang('reviews_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Reviews.Commonauth.Delete')) : ?>

            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('reviews_delete_confirm'); ?>')">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('reviews_delete_record'); ?>
            </button>
