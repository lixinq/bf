<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Reviews.User.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Reviews.User.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/user/reviews/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->reviews_video_id) ?></td>
				<?php else: ?>
